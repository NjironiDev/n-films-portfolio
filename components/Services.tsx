...
const services = [
  {
    ...
    icon: <IconChairDirector size={60} />,
  },
  {
    title: "COMMERCIAL",
    description:
    ...
    icon: <IconSpeakerphone size={60} />,
  },
  {
    title: "MOTION DESIGN",
    icon: <IconBounceRight size={60} />,
    description:
        ...
        <div className="max-w-6xl m-auto flex flex-col gap-10">
          ...
          <div className="grid grid-cols-3 gap-10">
            {services.map((service) => (
              <div
                className="card flex p-[3rem] px-[3.5rem] flex-1 flex-col justify-between gap-4
              hover:bg-opacity-40 transition-all duration-500 ease-in-out hover:scale-105 
              "
              >
                {service.icon}
                <h1
                  className={`text-2xl font-black text-black ${lato.className}
                  `}
                >
                  {service.title}
                </h1>
